    ...
    return (
        <div class="uk-container" style={{marginTop: 16}}>
            ...
            <div class="uk-text-center" style={{width: "100%", alignContent: "center", marginTop: 16}}>
                ...
                <a href="https://github.com/orifriesen/levelset" target="_blank"><button class="submitForm"><div style={{marginLeft: 8, display: "inline-block"}}>View Source Code</div> <span uk-icon="link"></span></button></a>
            </div>
        </div>
    );
};
